This MERN stack based exercise application is a web based application and uses Node.js as the backend, React as the frontend with Express.js for routing and MongoDB for data storage. 
